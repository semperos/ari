...
// ## CLI ari
//
// The CLI application at `github.com/semperos/ari/cmd/ari` provides a REPL for interactive
// programming. This interface is ideal when first learning Goal, using Goal as an ad hoc
// calculator, or when building a REPL-based user experience.
//
// You can use the Goal `ac` function with a string argument for glob matching
...
//
//   - A REPL with dedicated Goal and SQL modes, system commands starting with `)`, multiple output
